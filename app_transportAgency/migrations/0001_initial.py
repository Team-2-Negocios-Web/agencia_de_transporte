    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('2', 'en viaje'), ('1', 'A tiempo'), ('4', 'cancelado'), ('3', 'finalizado')], default='1', max_length=1)),
                ('routes', models.ManyToManyField(to='app_transportAgency.Route')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
